...
class __TwigTemplate_f64024a89137544d061cf85538169a5f extends Template
{
    private $source;
    private $macros = [];
...
{% block content %}
    ...
    {{ form(form) }}
    <hr>
{% endblock %}", "account/password.html.twig", "/Users/andranikhakobyan/Downloads/la-boutique-francaise-master 2/templates/account/password.html.twig");
    }
}
